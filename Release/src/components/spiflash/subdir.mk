...
C_SRCS += \
../src/components/spiflash/sfud.c 

C_DEPS += \
./src/components/spiflash/sfud.d 

OBJS += \
./src/components/spiflash/sfud.o 


# Each subdirectory must supply rules for building sources it contributes
src/components/spiflash/%.o: ../src/components/spiflash/%.c src/components/spiflash/subdir.mk
	@echo 'Building file: $<'
